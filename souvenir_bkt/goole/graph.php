...
class GA{
	...
	function penikmat($analytics, $profileId, $start_date, $end_date) {
	  // Calls the Core Reporting API and queries for the number of sessions
	  // for the last seven days.
	$optiParams = array( //OPTINAL SETTINGS
	...
	function tampilpenikmat(){
		$pageViews = Analytics::performQuery(Period::days(7), 'ga:uniquePageviews', ['dimensions'=>['ga:pageTitle', 'ga:anotherDimension','ga:anotherDimension'],'sort'=>'-ga:uniquePageviews']);
		echo $pageViews;
