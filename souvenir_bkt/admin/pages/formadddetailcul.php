...
<form role="form" action="act/addjnssouprocess.php" method="post">
        ...
        <form role="form" action="act/layananins.php" method="post">
          ...
          <option value="">-Choose-</option>
             <?php
              ...
              $kul=mysqli_query($conn,"select * from kuliner ");
              while($rowkul = mysqli_fetch_assoc($kul))
              {
        ...
        <?php } if (isset($_GET['id_tempat_kuliner'])){
          ...
          $sql = mysqli_query($conn,"SELECT * FROM jenis_industri where id_tempat_kuliner=$id_tempat_kuliner");
