...
if(isset($_GET['id']))
  ...
  $sql=mysqli_query("DELETE from detail_product_souvenir where id_souvenir='$id'");
  //$sql3=pg_query("DELETE from detail_facility_culinary where id_culinary_place='$id'");
  $sql1=mysqli_query("DELETE from detail_souvenir where id_souvenir='$id'");
  $sql4=mysqli_query("DELETE from souvenir_gallery where id='$id'");
