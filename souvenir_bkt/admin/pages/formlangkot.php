			...
			<div id="forml">
				<input type="text" class="form-control hidden" id="id" name="id" value="<?php echo $id_culinary_place ?>">
					...
					<tr>
						...
						<?php
							$sql2 = mysqli_query($conn,"select * from angkot order by id");
							while($dt = mysqli_fetch_array($sql2))
							{ ?> <tr> <?php
								$sql3 = mysqli_query($conn,"SELECT * FROM detail_culinary_place where id_culinary_place='$id_culinary_place' and id_angkot='$dt[id]'");
