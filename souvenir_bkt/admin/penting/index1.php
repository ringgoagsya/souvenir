         ...
         <div class="form-group">
          ...
          <option value="">-Choose-</option>
             <?php
              ...
              $stat=mysqli_query($conn,"select * from status_tempat ");
        ...
        <div class="form-group">
          ...
          <option value="">-Choose-</option>
             <?php
              ...
              $jns=mysqli_query($conn,"select * from jenis_industri ");
         ...
         <div class="form-group">
          ...
          <option value="">-Choose-</option>
             <?php
              ...
              $kecam=mysqli_query("select * from kecamatan ");
              while($rowkecam = mysqli_fetch_assoc($kecam))
              {
