...
$sql = mysqli_query($conn,"insert into oleh_oleh (foto, id_oleh_oleh, nama_oleh_oleh, pemilik, cp, alamat,produk, harga_barang, id_status_tempat, jumlah_karyawan, id_jenis_oleh,  geom) values ('$name', '$id_oleh_oleh', '$nama', '$pemilik', '$cp', '$alamat', '$product', '$harga', '$stat', '$jml', '$jns',  ST_GeomFromText('$geom'))");
