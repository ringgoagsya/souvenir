      ...
      <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header" style="background:black">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title" id="modal_title">Information</h4>
            </div>
            <div class="modal-body" id="modal_body">
            <p>Terjadi kesalahan, terdapat posisi yang belum ditentukan.<br>Muat ulang data untuk menjalankan fungsi ini</p>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
                      ...
                      <div class="col-md-12 col-sm-12 mb">
                        <div class="white-panel pns" style="height:200px">
                           <div class="white-header">
                             <h5 style='color:black'>LT Recommendations</h5>
                           </div>
      ...
      *********************************************************************************************************************************************************** -->                  
             ...
             <!-- <div id="galleryrecommend" class="col-md-4 col-sm-4 mb" style="margin-top:0px; display:block;">
                        <div class="white-panel pns" style="height:510px">
                          ...
                          <div style="height:475px; overflow: scroll;  margin:20px;">
                            <div class="container2">
                              <div class="row2" >
                                <div class="mySlides">
                                  <a href="" onclick="galeri('C006')"><img src="../_foto/C006-2.jpg" style="width:100%"><div class="text">Ambacang</div></a>
                                </div>
                                <div class="mySlides">
                                  <a href="" onclick="galeri('15')"><img src="../_foto/15-1.jpg" style="width:100%"><div class="text">Belakang Balok</div></a>
                                </div>
                                <div class="mySlides">
                                  <a href="" onclick="galeri('19')"><img src="../_foto/19-1.jpg" style="width:100%"><div class="text">Aur</div></a>
                                </div>
                                <div class="mySlides">
                                  <a href="" onclick="galeri('A004')"><img src="../_foto/A004-1.jpg" style="width:100%"><div class="text">Garegeh</div></a>
                                </div>
                              ...
                              <div class="row2">
                                <div class="column">
                                  <img class="demo cursor" src="../_foto/C006-2.jpg" style="width:100%" onclick="currentSlide(1)">
                                </div>
                                <div class="column">
                                  <img class="demo cursor" src="../_foto/15-1.jpg" style="width:100%" onclick="currentSlide(2)">
                                </div>
                                <div class="column">
                                  <img class="demo cursor" src="../_foto/19-1.jpg" style="width:100%" onclick="currentSlide(3)">
                                </div>
                                <div class="column">
                                  <img class="demo cursor" src="../_foto/A004-1.jpg" style="width:100%" onclick="currentSlide(4)">
                                </div>
                        ...
                        <div class="white-panel pns" style="height:510px">
                          ...
                          <div style="height:410px;  margin:20px;">
                            <div class="container2">
                              <div class="row2" >
                                <div class="mySlides">
                                  <a href="" onclick="galeri('C006')"><img src="../_foto/C006-2.jpg" style="width:100%;height:280px"><div class="text bg-black">Ambacang</div></a>
                                </div>
                                <div class="mySlides">
                                  <a href="" onclick="galeri('15')"><img src="../_foto/15-1.jpg" style="width:100%;height:280px"><div class="text bg-black">Belakang Balok</div></a>
                                </div>
                                <div class="mySlides">
                                  <a href="" onclick="galeri('19')"><img src="../_foto/19-1.jpg" style="width:100%;height:280px"><div class="text bg-black">Aur</div></a>
                                </div>
                                <div class="mySlides">
                                  <a href="" onclick="galeri('A004')"><img src="../_foto/A004-1.jpg" style="width:100%;height:280px"><div class="text bg-black">Garegeh</div></a>
                                </div>
                                <a class="prev" onclick="plusSlides(-1)">❮</a>
                                <a class="next" onclick="plusSlides(1)">❯</a>
                              </div>  
                    ...
                    <div id="view_kanan_track" class="col-md-4 col-sm-4 mb" style="margin-top:20px;display:none">
                        <div class="white-panel pns">
                           <div class="white-header" style="height:40px;margin:20px;background:white;color:white">
                             <h5 class="btn btn-compose" id="judul_select">LT Recommendations</h5>
                           </div>
                           <div class="row">
                             <div class="col-sm-6 col-xs-6"></div>
                           </div>
