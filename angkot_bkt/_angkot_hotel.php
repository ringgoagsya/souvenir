<?php
    ...
    $result=  mysqli_query($conn, "SELECT detail_hotel.id_hotel, hotel.name, st_x(st_centroid(hotel.geom)) as lng2, st_y(st_centroid(hotel.geom)) as lat2, detail_hotel.lat, detail_hotel.lng, detail_hotel.description FROM detail_hotel left join hotel on hotel.id=detail_hotel.id_hotel where detail_hotel.id_angkot='$id_angkot' ");
